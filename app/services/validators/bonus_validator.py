...
class BonusValidator:
    ...
    def validate_bonus_calculation(self, purchase_amount: Decimal, level: int, bonus: Decimal) -> bool:
        ...
        bonus_rates = {
            1: Decimal('0.007'),  # Premio del 0.7% in grammi dell'oro acquisito
            2: Decimal('0.005'),  # Premio del 0.5% in grammi dell'oro acquisito
            3: Decimal('0.005')   # Premio del 0.5% in grammi dell'oro acquisito
        }
