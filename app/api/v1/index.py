...
api_v1.register_blueprint(bonuses.bonuses_bp)
...
api_v1.register_blueprint(transformations.transformations_bp)
api_v1.register_blueprint(validation.validation_bp)
